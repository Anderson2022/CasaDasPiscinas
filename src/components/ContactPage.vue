...
<div class="my-6">
            <div class="grid sm:grid-cols-2 items-center gap-16 p-8 mx-auto max-w-4xl bg-white shadow-[0_2px_10px_-3px_rgba(6,81,237,0.3)] rounded-md text-[#333] font-[sans-serif]">
                <div>
                    ...
                    <p class="text-sm text-gray-400 mt-3">Fale conosco pelo telefone, whatsapp ou e-mail. Se voçê tem alguma duvida sobre nossos produtos, pro favor selecione o canal de atendimento adquado</p>
                    <div class="mt-12">
                        ...
                        <ul class="mt-3">
                            <li class="flex items-center">
                                ...
                                <a target="blank" href="https://veilmail.io/e/FkKh7o" class="text-[#007bff] text-sm ml-3">
                                    ...
                                    <strong>piscinac779@gmail.com</strong>
                                </a>
                            </li>
                        </ul>
                    </div>
